...
I am a PhD student in the [Center for Learning Systems](https://learning-systems.org) program advised by Andreas Krause at [ETH Zürich](https://ethz.ch/en.html) and Bernhard Schölkopf at the [MPI for Intelligent Systems](https://is.mpg.de) in Tübingen. Prior to this, I completed my Bachelor’s and Master's degrees at ETH Zürich, which included an exchange quarter at the [University of Washington](https://www.washington.edu).

My research focuses on scalable and sample-efficient learning from interaction. I am currently working on world models that learn abstract representations of their environment.

Feel free to reach out to me about research interests and ideas; I am always happy to chat. (ldiazbone@ethz.ch)
